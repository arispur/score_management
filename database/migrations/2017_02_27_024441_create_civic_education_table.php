...
class CreateCivicEducationTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('civic_education', function(Blueprint $table)
        {
            $table->increments('id');
            ...
            $table->integer('civic_education_score');
            $table->timestamps();
        });
    }
