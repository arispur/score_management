        ...
        <div class="right_col" role="main">
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Score <small>input score physics SMKN 2 Bandung</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    {!! Form::model($physics, ['route' => ['mathematic.update', $physics->id], 'method' => 'PUT', 'class' => 'form-horizontal form-label-left', 'id' =>'demo-form2', 'role' => 'form']) !!}
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="id_nis">NIS <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="id_nis" id="id_nis" required="required" class="form-control col-md-7 col-xs-12" value="{{ $physics->id_nis }}">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           <select name="id_nip" class="form-control" required="required">
                            <option value="{{ $physics->teacher_name }}"><?php echo $physics -> teacher_name; ?></option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="daily_exam_1" id="daily_exam_1" required="required" class="form-control col-md-7 col-xs-12" value="{{ $physics->daily_exam_1 }}">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="daily_task_1">Daily Task 1</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="daily_task_1" id="daily_task_1" required="required" class="form-control col-md-7 col-xs-12" value="{{ $physics->daily_task_1 }}">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="daily_exam_2">Daily Exam 2</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="daily_exam_2" id="daily_exam_2" required="required" class="form-control col-md-7 col-xs-12" value="{{ $physics->daily_exam_2 }}">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="midterm_tests">Midterm Tests</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="midterm_tests" id="midterm_tests" required="required" class="form-control col-md-7 col-xs-12" value="{{ $physics->midterm_tests }}">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="daily_task_2">Daily Task 2</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="daily_task_2" id="daily_task_2" required="required" class="form-control col-md-7 col-xs-12" value="{{ $physics->daily_task_2 }}">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="daily_exam_3">Daily Exam 3</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="daily_exam_3" id="daily_exam_3" required="required" class="form-control col-md-7 col-xs-12" value="{{ $physics->daily_exam_3 }}">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="daily_task_3" id="daily_task_3" required="required" class="form-control col-md-7 col-xs-12" value="{{ $physics->daily_task_3 }}">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="final_exam">Final Exam</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="final_exam" id="final_exam" required="required" class="form-control col-md-7 col-xs-12" value="{{ $physics->final_exam }}">
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a class="btn btn-primary" href="/physics">Cancel</a>
