        ...
        <div class="right_col" role="main">
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Score <small>score mathematics SMKN 2 Bandung</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    {!! Form::open(['url' => 'mathematics', 'id' =>'demo-form2', 'class' => 'form-horizontal form-label-left', 'role' => 'form']) !!}
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nis">NIS </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="nis" class="control-label col-md-7 col-xs-12">{{ $mathematics->id_nis }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="full_name">Full Name </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="name" class="control-label col-md-7 col-xs-12">{{ $mathematics->student_name }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="teacher_name">Teacher Name </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="name" class="control-label col-md-7 col-xs-12">{{ $mathematics->teacher_name }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="daily_exam_1">Daily Exam 1</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="name" class="control-label col-md-7 col-xs-12">{{ $mathematics->daily_exam_1 }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="daily_task_1">Daily Task 1</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="name" class="control-label col-md-7 col-xs-12">{{ $mathematics->daily_task_1 }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="daily_exam_2">Daily Exam 2</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="name" class="control-label col-md-7 col-xs-12">{{ $mathematics->daily_exam_2 }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="midterm_tests">Midterm Tests</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="name" class="control-label col-md-7 col-xs-12">{{ $mathematics->midterm_tests }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="daily_task_2">Daily Task 2</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="name" class="control-label col-md-7 col-xs-12">{{ $mathematics->daily_task_2 }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="daily_exam_3">Daily Exam 3</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="name" class="control-label col-md-7 col-xs-12">{{ $mathematics->daily_exam_3 }}</label>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="name" class="control-label col-md-7 col-xs-12">{{ $mathematics->daily_task_3 }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="final_exam">Final Exam</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="name" class="control-label col-md-7 col-xs-12">{{ $mathematics->final_exam }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="final_exam">Report Score</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="name" class="control-label col-md-7 col-xs-12">{{ $mathematics->mathematics_score }}</label>
                        </div>
                      </div>
