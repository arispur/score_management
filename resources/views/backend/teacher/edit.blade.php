        ...
        <div class="right_col" role="main">
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Teacher <small>input teacher SMKN 2 Bandung</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    {!! Form::model($teacher, ['route' => ['teacher.update', $teacher->nip], 'method' => 'PUT', 'class' => 'form-horizontal form-label-left', 'id' =>'demo-form2', 'role' => 'form']) !!}
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nip">NIP <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          {!! Form::text('nip', null, ['class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'NIP', 'required' => 'required']) !!}
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          {!! Form::text('teacher_name', null, ['class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Full Name', 'required' => 'required']) !!}
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="input-group date">
                              <input type="date" class="form-control" name="date_birth" required="required" value="{{ $teacher->date_birth }}">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="subject_id" class="form-control" required="required">
                            <option value="{{ $teacher->subject_id }}">{{ $teacher->subject_name }}</option>
                            @foreach ($subject as $data)
                            <option value= {{$data -> id_subject}}><?php echo $data -> subject_name; ?></option>
                            @endforeach
                          </select>
                        </div>
                      </div>
