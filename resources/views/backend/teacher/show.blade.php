        ...
        <div class="right_col" role="main">
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>{{ $teacher->teacher_name }}<small>teacher SMKN 2 Bandung</small></h2>
                    ...
                    {!! Form::open(['id' =>'demo-form2', 'class' => 'form-horizontal form-label-left', 'role' => 'form']) !!}
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="nip" class="control-label col-md-7 col-xs-12">{{ $teacher->nip }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Name</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="name" class="control-label col-md-7 col-xs-12">{{ $teacher->teacher_name }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="gender">Gender</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="gender" class="control-label col-md-7 col-xs-12">{{ $teacher->gender }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="date_birth">Date Birth</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="date_birth" class="control-label col-md-7 col-xs-12">{{ $teacher->date_birth }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="subject">Subject</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="subject" class="control-label col-md-7 col-xs-12">{{ $teacher->subject_name }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="address">Address</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="address" class="control-label col-md-7 col-xs-12">{{ $teacher->address }}</label>
                        </div>
                      </div>
