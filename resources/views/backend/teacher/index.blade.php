        ...
        <div class="right_col" role="main">
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      <div class="x_title">
                        <h2>Teacher <small>Teacher of SMKN 2 Bandung</small></h2>
                        <ul class="nav navbar-right panel_toolbox">
                          <a class="btn btn-success btn-round btn-xm" type="button" href="{{ url('teacher/create') }}">Add Teacher</a>
                        </ul>
                        <div class="clearfix"></div>
                      </div>
                      <div class="x_content">
                          ...
                          <tbody>
                            @foreach ($teacher as $data)
                              <tr>
                                  ...
                                  <td>
                                      <a class="btn btn-s btn-default" href="{{ URL('teacher/' . $data->nip) }}">Read</a>
                                      <a class="btn btn-s btn-primary" href="{{ URL('teacher/' . $data->nip . '/edit') }}">Update</a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                {!! Form::open(['url' => 'teacher/' . $data->nip, 'class' => 'pull-right']) !!}
