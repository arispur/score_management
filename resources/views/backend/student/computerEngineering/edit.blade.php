          ...
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    {!! Form::model($student, ['route' => ['computerEngineering.update', $student->nis], 'method' => 'PUT', 'class' => 'form-horizontal form-label-left', 'id' =>'demo-form2', 'role' => 'form']) !!}
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nis">NIS <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          {!! Form::text('nis', null, ['class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'NIS', 'required' => 'required']) !!}
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          {!! Form::text('student_name', null, ['class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Full Name', 'required' => 'required']) !!}
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="input-group date">
                              <input type="date" class="form-control" name="date_birth" required="required" value="{{ $student->date_birth }}">
