        ...
        <div class="right_col" role="main">
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>{{ $student->name }}<small>student computer engineering SMKN 2 Bandung</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    {!! Form::open(['id' =>'demo-form2', 'class' => 'form-horizontal form-label-left', 'role' => 'form']) !!}
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="nis">NIS</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="nis" class="control-label col-md-7 col-xs-12">{{ $student->nis }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Name</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="name" class="control-label col-md-7 col-xs-12">{{ $student->student_name }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="gender">Gender</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="gender" class="control-label col-md-7 col-xs-12">{{ $student->gender }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="subject">Class</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="subject" class="control-label col-md-7 col-xs-12">{{ $student->class }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="date_birth">Date Birth</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="date_birth" class="control-label col-md-7 col-xs-12">{{ $student->date_birth }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="address">Address</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="address" class="control-label col-md-7 col-xs-12">{{ $student->address }}</label>
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a class="btn btn-primary" href="/computerEngineering">Back</a>
                        </div>
                      </div>
                    </form>
        </div>
