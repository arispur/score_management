        ...
        <div class="right_col" role="main">
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>User <small>input user</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    {!! Form::open(['url' => 'user', 'id' =>'demo-form2', 'class' => 'form-horizontal form-label-left', 'role' => 'form']) !!}
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" name="password_confirmation" id="password_confirmation" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
