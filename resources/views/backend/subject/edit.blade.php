        ...
        <div class="right_col" role="main">
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Subject <small>edit subject SMKN 2 Bandung</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    {!! Form::model($subject, ['route' => ['subject.update', $subject->id_subject], 'method' => 'PUT', 'class' => 'form-horizontal form-label-left', 'id' =>'demo-form2', 'role' => 'form']) !!}
                    {!! Form::hidden('id_subject',$subject->id_subject,['class' => 'form-control']) !!}
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="subject_name">Subject Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          {!! Form::text('subject_name', null, ['class' => 'form-control col-md-7 col-xs-12', 'placeholder' => 'Subject Name', 'required' => 'required']) !!}
                        </div>
                      </div>
                      <div class="form-group">
