        ...
        <div class="right_col" role="main">
          <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>{{ $subject->subject_name }}<small>Subject SMKN 2 Bandung</small></h2>
                    ...
                    {!! Form::open(['id' =>'demo-form2', 'class' => 'form-horizontal form-label-left', 'role' => 'form']) !!}
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="id" class="control-label col-md-7 col-xs-12">{{ $subject->id_subject }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Name</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="name" class="control-label col-md-7 col-xs-12">{{ $subject->subject_name }}</label>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="description">Description</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <label id="description" class="control-label col-md-7 col-xs-12">{{ $subject->description }}</label>
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <a class="btn btn-primary" href="/subject">Back</a>
                        </div>
                      </div>
                    </form>
        </div>
